...
public class TodoListAdapter extends RecyclerView.Adapter<TodoViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TodoViewHolder holder, int position) {
        ...
        String current = todoList.get(todoList.size() - position - 1).getContent();
        String createAt = todoList.get(todoList.size() - position - 1).getCreateAt();
        // Add the data to the view holder.
        holder.todoItemView.setText(current);
        holder.createAtItemView.setText(createAt);
    }
